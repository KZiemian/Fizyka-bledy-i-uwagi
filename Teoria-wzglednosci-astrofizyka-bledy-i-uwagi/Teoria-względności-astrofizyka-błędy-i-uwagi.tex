...
% --------------------------------------------------------------------
% Title, author, date
\title{Teoria względności i~astrofizyka, błędy i~uwagi}
...
\Work{ % Autor i tytuł dzieła
  ...
  ,,Czasoprzestrzeń i~grawitacja'', \cite{KopczynskiTrautmanCzasoprzetrzenIGrawitacja84} }


\CenterTB{Uwagi}

\start \Str{33} Według mi~się, że~$l$ przebiega tylko zakres $0, n - 1$, ale~to trzeba sprawdzić.
